const t = {
  zh: {
    ...
    modalGoogleLogin: '使用 Google 帳號登入報名',
    modalGoogleHint: '登入後未來可查詢報名紀錄',
    modalOr: '或直接填寫',
  ...
  en: {
    ...
    modalGoogleLogin: 'Sign in with Google to sign up',
    modalGoogleHint: 'Sign in to view your signup history later',
    modalOr: 'or fill in manually',
