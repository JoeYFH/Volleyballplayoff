const t = {
  zh: {
    ...
    fDate: '日期', fTime: '時間',
    fLocation: '地點', fLocationPh: '輸入或搜尋地點',
    fVenue: '場地詳細（選填）', fVenuePh: '例：B1 室內球場4號場',
    fLimit: '人數上限（0 = 不限）', fType: '性別分類',
    fEquip: '需要攜帶的用具', fEquipPh: '其他用具（逗號分隔）',
  ...
  en: {
    ...
    fLocation: 'Location', fLocationPh: 'Enter or search location',
    fVenue: 'Venue Detail (optional)', fVenuePh: 'e.g. Court B1, Indoor Hall',
    fLimit: 'Player Limit (0 = unlimited)', fType: 'Category',
    fEquip: 'Required Equipment', fEquipPh: 'Other items (comma separated)',
